    ...
    <form onSubmit={handleSubmit}>
      <div className="bg-gray-50 dark:bg-gray-900 min-h-screen md:px-20 pt-6">
        <div className=" bg-white dark:bg-gray-800 dark:border-gray-700 rounded-md px-6 py-10 max-w-2xl mx-auto mt-32">
          <h1 className="text-center text-2xl font-bold text-white mb-10 md:text-2xl dark:text-white font-serif">UPDATE POST</h1>
          <div className="space-y-4">
            ...
            <button className=" text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 px-6 py-2 mx-auto block rounded-md text-lg font-semibold">UPDATE POST</button>
          </div>
        </div>
      </div>
    </form >
